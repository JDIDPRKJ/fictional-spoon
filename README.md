### Mandar **SPAM** a un correo electronico (gmail/outlook)
> Se añadira soporte para mas

###### No se requieren librerias adicionales

###### Puede ingresar la ruta de un diccionario con los correos (archivo txt)

| Comando | Funcion |
| --- | --- |
| cls | Limpia la terminal |
| help | Muestra ayuda|
| log | Muestra el contenido de el registro `(-c para limpiarlo)` - `(-a agregar una nota en el log`|
| version | Muestra la version de el programa|
| bomb | Iniciar un spam a un correo |
